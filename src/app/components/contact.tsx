    ...
    <section id="contact" className="py-20 px-4 bg-gray-100 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Whether you want to collaborate, need help building a project, or
          simply want to say hi — feel free to reach out. I’ll get back to you
          as soon as I can.
        </motion.p>
        ...
        >
          ...
          {/* MESSAGE */}
          <motion.div
            animate={status === "error" ? { x: [0, -10, 10, -8, 8, 0] } : {}}
          >
            <textarea
              required
              name="message"
          ...
          <div className="flex justify-end mt-4">
            <motion.button
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white rounded-xl shadow-md transition-all disabled:bg-blue-400"
